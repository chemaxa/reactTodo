...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoModel = __webpack_require__(168);
	...
	console.log(_todoModel2.default);
	var todoList = function todoList() {
	  _react2.default.createElement('ul', { 'class': 'list-group' });
	};
	...
	var TestInput = function (_React$Component) {
	  ...
	  _createClass(TestInput, [{
	    ...
	    value: function onBtnClickHandler() {
	      ...
	      console.log(_reactDom2.default.findDOMNode(this.refs.myTestInput).value);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { onClick: this.onBtnClickHandler.bind(this), ref: 'alert_button' },
	          'Показать значение'
	        )
	      );
	    }
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'col-md-12' },
	              _react2.default.createElement(TestInput, null)
	            )
	          )
	        )
	      );
